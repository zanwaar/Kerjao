                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-form-field label="GitHub Username" name="github_username">
                                <input type="text" name="github_username" value="{{ old('github_username') }}" class="form-control">
                            </x-form-field>
                        </div>
                        <div class="col-md-6">
                            <x-form-field label="WakaTime User Key" name="wakatime_user_key">
                                <input type="text" name="wakatime_user_key" value="{{ old('wakatime_user_key') }}" class="form-control">
                            </x-form-field>
                        </div>
                    </div>
